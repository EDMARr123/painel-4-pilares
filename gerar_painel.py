...
def _construir_secoes_dashboard(dados, dados_dep=None, totais=None, chave_grupo="supervisor", rotulo_grupo="supervisor", mostrar_resumo_4_pilares=False):
    ...
    <div class="dv-kpi {classe_recompra_geral}">
      ...
      <div class="v" style="display:flex;align-items:baseline;gap:10px;flex-wrap:wrap;">
        <span>{_fmt_pct_py(media_recompra_geral)}</span>
        <span style="font-size:13px;font-weight:700;color:var(--ink-faint);">{_fmt_num_py(qtd_1_pedido, 0)} com 01 pedido</span>
      </div>
